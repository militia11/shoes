...
void NaglowkiZamowienia::ustawNaglowki(QTableView *tableView, QAbstractItemModel *model) {
    ...
    listaZamowienia  << ""  << "NR ZAM" << "KL SK" << "KL NR"  << "WZÓR"  << "SPÓD" << "KOL" <<
                     ...
                     "SP PROD" << "UŻY" << "HAN" << "DATA WPROW" << "DATA WPR" << "DATA REALIZACJI" << "REKORD" << "CAŁE ZAM" << "STATUS"
                     << "STATUS" << "STATUS" << "STATUS"  << "LICZBA WYDRUKÓW" << "STATUS"    << "STATUS"  << "" << ""    << ""  << "" << ""
                     << ""  << "" << ""    << ""  << ""<< ""  << "" << ""    << ""  << ""                     << "" << ""  << "" << "";
...
void NaglowkiZamowienia::ustawNaglowkiWyd(QTableView *tableView, QAbstractItemModel *model) {
    QHeaderView *hv = tableView->horizontalHeader();
    hv->setSectionHidden(0, true);
    hv->setStretchLastSection(true);
    hv->setSectionHidden(33,true);
