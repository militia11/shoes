...
void MainWindow::on_radioButton_5_clicked() {
    ...
    ui->tableViewZam->horizontalHeader()->setSectionHidden(49,true);
    ui->pushButtondruk1->setVisible(false);
    ui->pushButtondruk2->setVisible(false); ui->tableViewZam->setSelectionMode(QAbstractItemView::SingleSelection);
}
...
void MainWindow::on_radioButton_4_clicked() {
    ...
    ui->tableViewZam->horizontalHeader()->setSectionHidden(49,true);
    ui->pushButtondruk1->setVisible(false);
    ui->pushButtondruk2->setVisible(false); ui->tableViewZam->setSelectionMode(QAbstractItemView::SingleSelection);     ui->tableViewZam->horizontalHeader()->setStretchLastSection(true);
}
